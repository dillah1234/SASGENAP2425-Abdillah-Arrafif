...
function Help() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-r from-blue-500 to-indigo-500 py-10">
      <button onClick={() => navigate("/login")} className="mb-6 p-3 bg-gray-800 text-white rounded-full hover:bg-gray-700 transition-all transform hover:scale-105">
        Back
      </button>
      <h1 className="text-4xl font-extrabold text-white mb-8 text-center tracking-wide">Help Page</h1>
  ...
  return (
    <div className="max-w-md mx-auto mt-12 bg-white p-8 rounded-xl shadow-xl space-y-6">
      ...
      <form onSubmit={handleCreateUser} className="space-y-6">
        ...
        <button type="submit" className="w-full p-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all transform hover:scale-105 shadow-md">Create User</button>
      </form>
      {message && <p className="text-green-600 text-center">{message}</p>}
      <button onClick={() => navigate(-1)} className="w-full mt-4 p-4 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-all transform hover:scale-105 shadow-md">Back</button>
    </div>
  );
}
...
const UserProfile = ({ user }) => {
  return (
    <div className="flex items-center p-4 bg-white rounded-lg shadow-md mb-6 hover:shadow-xl transition-all">
      <img src={user.avatar} alt={user.name} className="w-14 h-14 rounded-full mr-6" />
      <div>
...
const ReadUser = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-indigo-400 to-purple-500 py-12">
      <h1 className="text-4xl font-extrabold text-white text-center mb-10">User List</h1>
      <button onClick={() => navigate(-1)} className="p-3 bg-gray-700 text-white rounded-lg mb-6 hover:bg-gray-800 transition-all transform hover:scale-105">Back</button>
  ...
  return (
    <div className="max-w-md mx-auto mt-12 bg-white p-8 rounded-xl shadow-xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button type="submit" className="w-full p-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all transform hover:scale-105 shadow-md">Update User</button>
      </form>
      <button onClick={() => navigate("/help")} className="w-full mt-4 p-4 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-all transform hover:scale-105 shadow-md">Back</button>
    </div>
  );
};
